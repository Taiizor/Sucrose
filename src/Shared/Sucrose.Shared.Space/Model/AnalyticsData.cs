namespace Sucrose.Shared.Space.Model
{
    internal class AnalyticsData(bool AppExit, string GifEngine, bool Loop, string Url, string Web, bool Adult, string User, int Volume, string Input, string Model, bool Report, bool Server, string Store, string Theme, string Video, int Startup, bool Discord, string Screen, bool Shuffle, string Update, bool Visible, string Channel, string Culture, bool Cycyling, string Graphic, string Library, string Network, string Stretch, string Version, string YouTube, bool AutoUpdate, string Framework, string Processor, bool Statistics, bool StoreStart, bool Advertising, string Identifier, bool LibraryMove, long TotalMemory, bool Workstation, int CycylingTime, string Application, string CultureName, string Identifying, bool InputDesktop, string InputModule, bool LibraryStart, bool StorePreview, bool VolumeActive, int DeveloperPort, int NumberOfCores, int StoreDuration, string Architecture, bool DeveloperMode, bool DonateVisible, bool LibraryDelete, string Manufacturer, bool VolumeDesktop, string Communication, string DisplayScreen, bool LibraryConfirm, bool LibraryPreview, int StorePagination, string CpuPerformance, string CultureDisplay, string GpuPerformance, string GraphicAdapter, string NetworkAdapter, string TransitionType, int AdvertisingDelay, string BackgroundImage, string OperatingSystem, int BackgroundOpacity, int LibraryPagination, string FocusPerformance, string PausePerformance, string SaverPerformance, int NumberOfProcessors, string BackgroundStretch, string MemoryPerformance, bool PerformanceCounter, string RemotePerformance, string BatteryPerformance, string NetworkPerformance, string VirtualPerformance, string ProcessArchitecture, string OperatingSystemBuild, string FullscreenPerformance, string ProcessorArchitecture, string OperatingSystemArchitecture)
    {
        ...
        public string Screen { get; set; } = Screen;

        public bool Shuffle { get; set; } = Shuffle;
        ...
        public bool StoreStart { get; set; } = StoreStart;

        public bool Advertising { get; set; } = Advertising;
        ...
        public string Identifying { get; set; } = Identifying;

        public bool InputDesktop { get; set; } = InputDesktop;
