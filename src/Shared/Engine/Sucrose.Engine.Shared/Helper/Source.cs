...
namespace Sucrose.Engine.Shared.Helper
{
    internal static class Source
    {
        ...
        public static string GetYouTubeContent(string Video, string Playlist)
        {
            ...
            SEST Screen = SESHD.GetScreenType();
            SSDEDT Display = SESHD.GetDisplayType();

            switch (Display)
            {
                case SSDEDT.Expand:
                    SSMMS EMonitor = SWHSM.OwnerScreen(SESHD.GetExpandScreenType()); Content = Screen switch
                    {
                ...
                case SSDEDT.Duplicate:
                    ...
                    break;
                default:
                    SSMMS SMonitor = SWHSM.OwnerScreen(SESHD.GetScreenIndex());
                    Content = Screen switch
                    {
