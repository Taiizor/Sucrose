...
namespace Sucrose.Portal.Controls
{
    ...
    {
        public static readonly DependencyProperty ItemMarginProperty = DependencyProperty.Register("ItemMargin", typeof(Thickness), typeof(CustomWrapPanel), new FrameworkPropertyMetadata(new Thickness(0)));
        ...
        public static readonly DependencyProperty MaxItemsPerRowProperty = DependencyProperty.Register("MaxItemsPerRow", typeof(int), typeof(CustomWrapPanel), new FrameworkPropertyMetadata(int.MaxValue, MaxItemsPerRowPropertyChanged));
        ...
        {
            CustomWrapPanel panel = d as CustomWrapPanel;
