...
namespace Avalonia.Gif
{
    public class GifImage : Control
    {
        ...
        private void Update()
        {
            ...
            Size sourceSize = _gifInstance.GifPixelSize.ToSize(dpi);
        ...
        private class CustomVisualHandler : CompositionCustomVisualHandler
        {
            ...
            public override void OnRender(ImmediateDrawingContext drawingContext)
            {
                ...
                try
                {
                    ...
                    Media.Imaging.WriteableBitmap? bitmap = _currentInstance.ProcessFrameTime(_animationElapsed);
        ...
        {
            Size result = new();
            double scaling = this.GetVisualRoot()?.RenderScaling ?? 1.0;
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            double scaling = this.GetVisualRoot()?.RenderScaling ?? 1.0;
            Size sourceSize = _gifInstance.GifPixelSize.ToSize(scaling);
